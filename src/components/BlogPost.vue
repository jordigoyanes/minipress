          ...
          <div class="col-md-12 col-lg-8 main-content">
            ...
            <div class="row mb-5">
              <div class="col-md-12 mb-4 element-animate">
                <img src="../assets/img_7.jpg" alt="Image placeholder" class="img-fluid">
              </div>
              <div class="col-md-6 mb-4 element-animate">
                <img src="../assets/img_9.jpg" alt="Image placeholder" class="img-fluid">
              </div>
              <div class="col-md-6 mb-4 element-animate">
                <img src="../assets/img_11.jpg" alt="Image placeholder" class="img-fluid">
              </div>
            </div>
